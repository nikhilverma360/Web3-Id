      ...
      <div style={{ padding: "15px", maxWidth: "1030px", width: "100%" }}>
        <div className="container mx-auto p-5">
          ...
          <div className="flex flex-row">
            <div className="basis-1/4"><img className="max-h-32 aspect-square" alt="Profile" src={avatar} /></div>
          ...
          <br /><hr /><br />
          <h1 className="text-2xl font-bold text-center ">Trust Score : 87</h1>
          <br /><hr /><br />
          <h1 className="text-2xl font-bold text-center underline ">About</h1>
